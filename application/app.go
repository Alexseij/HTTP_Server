...
func (a *App) setHandlers() {
	...
	a.Get("/api/user/getCurrentRatingProvider/{email}", a.handleReq(users.GetCurrentRatingProvider))
	a.Get("/api/user/getCurrentRatingConsumer/{email}", a.handleReq(users.GetCurrentRatingConsumer))
